...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>cloudzono</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('css/styles.css') }}" id="theme_mode">
                ...
                <div class="flex flex-col">
                        ...
                        <div class="flex items-center justify-center gap-2 sm:gap-4 h-full">
                            ...
                            <a href="index.php?&amp;" class="block">
                                <div class="main-logo w-44">
                                    <p>Cloudzono</p>
                                    {{-- <img src="https://www.virtono.com/images/virtono.png"> --}}
                                </div>
                            </a>
                        </div>
                    </header>
                    ...
                    <div class="flex md:h-[calc(100vh-80px)] h-full overflow-hidden">
                        ...
                        <aside id="sideBar"
                            ...
                            <div
                                class="flex flex-col overflow-y-auto no-scrollbar duration-300 ease-linear p-2 h-full">
                                <nav class="flex flex-col gap-1 p-1">
                                    ...
                                    <a href="javascript:loadpage('act=listvs');" class="lm-link-class "
                                        id="lmlistvs">
                                        <span class="left_menu_i"><svg class="h-6 inline" viewBox="0 0 512 512"
                                                ...
                                                <g id="">
                                                    ...
                                                    <rect width="480" height="32" x="16" y="400"
                                                        class="ci-primary" fill="#005BFF"></rect>
                                                </g>
                                            </svg></span>
                                    ...
                                    <a href="javascript:loadpage('act=sshkeys')" id="lmsshkeys"
                                        class="lm-link-class">
                                        <span class="left_menu_i"><svg class="h-7 inline" viewBox="0 0 28.80 28.80"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g id="" stroke-width="0"></g>
                                    ...
                                    <a href="javascript:loadpage('act=euiso')" id="lmeuiso" class="lm-link-class">
                                        <span class="left_menu_i"><svg class="h-6 inline" fill="#666D80"
...
<span class="lm_names whitespace-nowrap">Applications</span>
                                    ...
                                    <a href="javascript:loadpage('act=load_balancer')" id="lmload_balancer"
                                        class="!hidden lm-link-class">
                                        <span class="left_menu_i"><svg class="h-6 inline" fill="#005BFF"
                                    ...
                                    <a href="javascript:loadpage('act=firewallplan')" id="lmfirewallplan"
                                        class="lm-link-class">
                                        <span class="left_menu_i"><svg class="h-6 inline"
                                                viewBox="-2.4 -2.4 28.8 28.8" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g stroke-width="0"></g>
                                                <g stroke-linecap="round" stroke-linejoin="round"></g>
                                            ...
                                            <div id="pagelinks_vslist">
                                                ...
                                                <div id="showsearch" class=" w-full px-4 py-3" style="display:none;">
                                                    <form accept-charset="UTF-8" name="listvs_search" method="get"
                                                        ...
                                                        <div class="flex gap-3 mb-3 px-2">
                                                            <div class="w-1/4">
                                                                <label for="vpsid"
                                                                    class="block label-text">ID</label>
                                                        ...
                                                        <div class="flex gap-3 mb-3 px-2">
                                                            ...
                                                            <div class="w-1/4 hidden" id="search-greoup-div">
                                                                <label for="group-option"
                                                                    class="block label-text">Server Group</label>
                                                                <select
                                                        ...
                                                        <div class="flex  mb-2 px-2">
                                                            <div class="w-1/4">
                                                                <button type="button" name="search"
                                                                    class="btn mb-2" value="Search" id="vsSearch"
                                                ...
                                                <div id="vslist">
                                                    <table class="table" id="vslist_list_table" border="0"
                                                        cellspacing="1" cellpadding="8" align="center"
                                                        width="100%">
                                                        <thead
                                                            ...
                                                            <tr
                                                                ...
                                                                <th width="3%"
                                                                    ...
                                                                    <div
                                                                        class="text-start flex items-center gap-2 uppercase">
                                                                        <span>الحالة<i id="refresh_status"
                                                                                class="fas fa-sync-alt p-1.5 mx-1 rounded-full bg-white shadow"
                                                                                aria-hidden="true"
                                                                                onclick="loadpage('act=listvs');"></i></span>
                                                                    </div>
                                                                </th>
                                                                <th width="10%"
                                                                    class="!px-4 !py-3 font-medium cursor-pointer whitespace-nowrap">
                                                        ...
                                                        <tbody>
                                                            <tr
                                                                ...
                                                                <td class="!px-4 !py-5 whitespace-nowrap">0</td>
                                                                ...
                                                                <td class="!px-4 !py-5 whitespace-nowrap">
                                                                    <div
                                                                        class="flex flex-row items-center divide-x divide-[#ECEFF3] dark:divide-gray-700">
                                                                        <div class="flex flex-col gap-1 pr-2">
                                                                            <div
                                                                                ...
                                                                                <h4 class="listvs_vals">1024 MB</h4>
                                                                            </div>
                                                                            <div
                                                                                class="flex flex-row gap-1 items-center">
                                                                                <p class="listvs_vals_header">
                                                                ...
                                                                <td align="center"
                                                                    class="!px-4 !py-5 whitespace-nowrap"><span
                                                                        data-popover-target="stat_61364"
                                                                        data-popover-placement="right"><span
                                                                            class="!p-2 badge-red cursor-pointer shadow">Offline</span></span>
                                                                    <div data-popover="" id="stat_61364"
                                                                        role="tooltip"
                                                                        class="absolute z-40 opacity-0 invisible eu_menu_popover"
                                                                        data-popper-placement="right"
                                                                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1029.6px, 261.6px, 0px);">
                                                                        <div
                                                                            class="flex gap-4 items-center vpsmanage_icons px-2 py-2">
                                                                            <a href="javascript:void(0)"><i
                                                                                    class="fa fa-play power-on"
                                                                                    title="Start VPS"
                                                                                    aria-hidden="true"
                                                                                    onclick="jqueryvpsboot('start', 'stat_61364', 61364);"></i></a><a
                                                                                id="novncURL_61364" class="vncButton"
                                                                                href="index.php?&amp;act=vnc&amp;novnc=1&amp;jsnohf=1&amp;svs=61364"
                                                                                target="_blank"><i
                                                                ...
                                                                <td class="!px-4 !py-5 whitespace-nowrap">
                                                                    <span>
                                                                        <a class="cursor-pointer" title="Manage"
                                                                            onclick="loadpage('act=vpsmanage&amp;svs=61364');return false;">
                                                                ...
                                                                <td><input type="checkbox" class="ios virt-checkbox"
                                                                        name="vps_list[]" id="vps-checkbox61364"
                                                                        value="61364"></td>
                                                            </tr>
                                                            <tr
                                                                class="text-sm text-[#666D80] dark:text-[#989CAE] dark:hover:bg-[#00C88F14] hover:bg-[#00C88F14] transition-all duration-300 border-b border-b-[#ECEFF3] dark:border-b-gray-800">
                                                                <td class="!px-4 !py-5 whitespace-nowrap">61364</td>
                                                                <td class="!px-4 !py-5 whitespace-nowrap">
                                                                    <div class="flex items-center gap-2">
                                                                        <div class="w-10">
                                                                            <img tooltip="centos-7.9-x86_64"
                                                                                src="themes/default/images/svgset/centos.svg"
                                                                                alt="centos-7.9-x86_64"
                                                                                data-tooltip-target="ODwCoe"
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="pagination-bottom">
                                                        <div class="flex justify-between md:items-center md:flex-row flex-col gap-3 px-3 py-3 m-2><p class="
                                                            text-[#535a7a]="" dark:text-[#999fae]=""
                                                            text-sm="">الصفحة 1 من 1<p></p>
                                                            <div class="flex items-center gap-2"></div>
                                                        </div>
                                                    </div>
                                                </div>
