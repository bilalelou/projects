					...
					<header
						...
						<div class="flex items-center justify-center gap-2 sm:gap-4 h-full">
							...
							<a href="index.php?&amp;" class="block">
								<div class="main-logo w-44"><img src="https://www.virtono.com/images/virtono.png"></div>
							</a>
						</div>
					</header>
					<!-- NAV Ends -->
						...
						<aside id="sideBar"
							...
							<div class="flex flex-col overflow-y-auto no-scrollbar duration-300 ease-linear p-2 h-full">
								<nav class="flex flex-col gap-1 p-1">
									<div class="banner-yellow hidden cursor-pointer" id="virt_dev_banner">Dev License <i
											...
											Please report any cases of abuse to support@virtualizor.com</span></div>
													...
													<form accept-charset="UTF-8" name="listvs_search" method="get"
														...
														<div class="flex gap-3 mb-3 px-2">
															...
															<div class="w-1/4">
																...
																<input class="virt-input" type="text" name="vpshostname"
																	id="vpshostname">
															</div>
															<div class="w-1/4">
														...
														<thead
															...
															<tr
																...
																<th width="150"
																	...
																	<div
																		class="text-start flex items-center gap-2 uppercase">
																		<span>الاسم العميل</span></div>
																</th>
																<th width="150"
																	class="!px-4 !py-3 font-medium cursor-pointer whitespace-nowrap">
																	<div
																		class="text-start flex items-center gap-2 uppercase">
																		<span>المعلومات الخادمة</span></div>
																</th>
																<th width="150"
																	class="!px-4 !py-3 font-medium cursor-pointer whitespace-nowrap">
																	<div
																		class="text-start flex items-center gap-2 uppercase">
																		<span>رقم الهاتف</span></div>
																</th>
																<th width="3%"
																	class="!px-4 !py-3 font-medium cursor-pointer whitespace-nowrap">
																	<div
														...
														<tbody>
															<tr
																...
																<td align="center"
																	...
																	<div data-popover="" id="stat_61364" role="tooltip"
																		...
																		<div
																			...
																			<a href="javascript:void(0)"><i
																					...
																					title="Start VPS" aria-hidden="true"
